...
def scan():
    ...
    if text_file=="":
      ...
      er_label.place(x=700,y=500) 
        ...
        if flag==True:
            yes_label=Label(text="it has tumor !",width=17,height=2,bg="red",fg="white",font=("hellvetica",20))
            yes_label.place(x=700,y=500)

        else:
            no_label=Label(text="it does not have tumor",width=17,height=2,bg="green",fg="white",font=("hellvetica",20))
